...
__all__ = ['TensorQuaternionInclination', 'TensorQuaternionAngle', 'rad2deg', 'multiplyQuat', 'norm_quaternion',
           'conjQuat', 'diffQuat', 'safe_acos', 'inclinationAngle', 'relativeAngle', 'rollAngle', 'pitchAngle',
           'inclinationAngleAbs', 'rand_quat', 'rot_vec', 'inclination_loss', 'inclination_loss_abs',
           'inclination_loss_squared', 'inclination_loss_smooth', 'abs_inclination', 'ms_inclination',
           'rms_inclination', 'smooth_inclination', 'rms_inclination_deg', 'rms_pitch_deg', 'rms_roll_deg',
