...
__all__ = ['obj_in_lst', 'get_hdf_files', 'hdf_extensions', 'apply_df_tfms', 'CreateDict', 'DfHDFCreateWindows',
           'calc_shift_offsets', 'hdf_extract_sequence', 'Memoize', 'HDF2Sequence', 'hdf2scalars', 'TensorSequences',
           'TensorSequencesInput', 'TensorSequencesOutput', 'toTensorSequencesInput', 'toTensorSequencesOutput',
           'TensorScalars', 'TensorScalarsInput', 'TensorScalarsOutput', 'SeqSlice', 'SeqNoiseInjection', 'encodes',
           'decodes', 'ParentSplitter', 'PercentageSplitter', 'ApplyToDict', 'pad_sequence', 'SequenceBlock',
           'Seq2SeqDS', 'Seq2SeqDataloaders', 'plot_seqs_single_figure', 'plot_seqs_multi_figures']
...
#Cell
def plot_seqs_single_figure(n_samples,samples,plot_func,outs=None):
...
#Cell
def plot_seqs_multi_figures(n_samples,samples,plot_func,outs=None):
    n_targ = samples[0][1].shape[1]
    for i in range(n_samples):
